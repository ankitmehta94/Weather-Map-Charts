...
///////////DOM variables//////////////////////
    ...
    sideNav.sidebar('setting',{
        onShow: function() {
            $scope.iconClass = 'left';
    ...
    var getMinMaxStacked = function (list) {
        ...
        $scope.dataArea[0].values.push([datum.dt*1000,datum.temp.min]);
      });
    };
...
var cardFly = function (text) {
   chartCard1.transition({
            animation  : 'fly ' +text,
            duration   : '2s',
        });
    chartCard2.transition({
            animation  : 'fly ' +text,
            duration   : '2.3s',
        });
    chartCard3.transition({
            animation  : 'fly ' +text,
            duration   : '2.5s',
        });
}
